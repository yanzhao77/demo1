$().ready(function(){
	...
	$("#addUserSubmit").click(function(){
		...
		if(a_userCode == ''){
			...
			$.post("/addUser",{'userCode':a_userCode,'userName':a_userName,'userPassword':a_userPassword,'isStart':a_isStart,'roleId':a_roleId},function(result){
				if("success" == result){
					alert("添加成功！");
					window.location.href="/userAllList";
	...
	$("#modifyUserSubmit").click(function(){
		...
		if(m_userCode == ''){
			...
			$.post("/updateUser",{'id':m_userId,'userCode':m_userCode,'userName':m_userName,'isStart':m_isStart,'userPassword':m_userPassword,'roleId':m_roleId},function(result){
				if("success" == result){
					alert("修改成功！");
					window.location.href="/userAllList";
				}else if("repeat" == result){
